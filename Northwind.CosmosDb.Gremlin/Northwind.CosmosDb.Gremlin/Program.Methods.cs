...
using Northwind.Shared; // NorthwindContext, Product, Customer, and so on.
...
partial class Program
{
    ...
    private static string primaryKeyLocal =
        "C2y6yDjf5/R+ob0N8A7Cgv30VRDJIWEHLM+4QDU5DE2nQ9nDuVTqobD4b8mGGyPMbIZnqyMsEcaGQy67XIw/Jw==";

    // To use Azure Cosmos DB in the cloud.
    private static string account = "northwind"; // change to your account
    ...
    static async Task<(int, double)> ExecuteGremlinScript(string script)
    {
        ...
        try
        {
            ...
            )
            {
                ...
                if (
                    double.TryParse(
                        resultSet.StatusAttributes[RequestChargeHeader].ToString(),
                        out double requestCharge
                    )
                )
                {
        ...
        try
        {
            ...
            )
            {
                ...
                ContainerProperties containerProperties =
                    new(collection, partitionKeyPath: "/partitionKey")
                    {
                        IndexingPolicy = indexingPolicy
                    };
        ...
        try
        {
            using (NorthwindContext db = new())
            {
              ...
              """;
                        ...
                        WriteLine(
                            "{0} vertex was added at a cost of {1} RUs.",
                            added.Count,
                            added.Cost
                        );
                    }
