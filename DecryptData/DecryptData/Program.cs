...
using Northwind.Shared; // Protector
...
{
    WriteLine("You must enter a password.");
    return;
}
...
string xmlFile = Combine(
    CurrentDirectory,
    // "..", "protected-customers.xml"); // dotnet run
    "..",
    "..",
    "..",
    "..",
...
XmlReader xmlReader = XmlReader.Create(xmlFile, new XmlReaderSettings { IgnoreWhitespace = true });
...
WriteLine();
int number = 0;
WriteLine("    {0,-20} {1,-20}", arg0: "Name", arg1: "Credit Card");

foreach (Customer c in customers)
{
    WriteLine("[{0}] {1,-20} {2,-20}", arg0: number, arg1: c.Name, arg2: c.CreditCard);
