...
public static class Protector
{
    ...
    public static string Encrypt(string plainText, string password)
    {
        ...
        using (Aes aes = Aes.Create()) // abstract class factory method
        {
            ...
            {
                WriteLine(
                    "PBKDF2 algorithm: {0}, Iteration count: {1:N0}",
            ...
            WriteLine(
                "{0:N0} milliseconds to generate Key and IV.",
                arg0: timer.ElapsedMilliseconds
            );

            WriteLine(
                "Encryption algorithm: {0}-{1}, {2} mode with {3} padding.",
                "AES",
                aes.KeySize,
                aes.Mode,
                aes.Padding
    ...
    public static void LogIn(string username, string password)
    {
        ...
        {
            GenericIdentity gi = new(name: username, type: "NorthwindAuth");
