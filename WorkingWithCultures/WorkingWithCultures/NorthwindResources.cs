...
public class NorthwindResources
{
    private readonly IStringLocalizer<NorthwindResources> localizer = null!;

    public NorthwindResources(IStringLocalizer<NorthwindResources> localizer)
    {
