...
{
    public string DisplayPixelWidth => $"{DeviceDisplay.Current.MainDisplayInfo.Width} pixel width";
    ...
    public string DevicePlatform => $"Platform is {DeviceInfo.Current.Platform}";
    ...
    {
        IToast toast = Toast.Make(
            message: "This toast pops up.",
